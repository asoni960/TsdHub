...
import Fragment_Schedule_Page.Fragment_Recent;
...
public class Schedule_Main extends AppCompatActivity  {
    ...
    TabLayout schedule_tabLayout;
    ViewPager schedule_viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schedule_viewPager =(ViewPager) findViewById(R.id.schedule_viewPager);
        setupViewPager(schedule_viewPager);

        schedule_tabLayout= (TabLayout) findViewById(R.id.schedule_tabs);
        if (schedule_tabLayout != null) {
    ...
    private void initNavigationDrawer() {
        ...
        main_drawer = (DrawerLayout)findViewById(R.id.schedule_layout);
    ...
    //tab layout
    private void setupViewPager(ViewPager schedule_viewPager) {
        ViewPagerAdapter schedule_adapter= new ViewPagerAdapter(getSupportFragmentManager());
        schedule_adapter.addFragment(new Fragment_Recent(),"Live");
        schedule_adapter.addFragment(new Fragment_Recent(),"Recent");
        schedule_adapter.addFragment(new Fragment_Recent(),"Upcoming");
        schedule_viewPager.setAdapter(schedule_adapter);
    }
